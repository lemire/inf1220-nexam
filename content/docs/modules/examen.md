...
- Au sein du cours [INF 4450 Programmation orientée-données](https://communications.teluq.ca/site/etudes/offre/cours/TELUQ/INF%204450/), vous apprendrez à manipuler les formats de données structurées qui dominent le Web et la science des données (JSON, XML, HTML, YAML, RDF) et à les relier aux structures fondamentales de l'informatique (arbres, dictionnaires, listes, graphes), en Java principalement, mais aussi en JavaScript et en Python. Ce cours s'appuie directement sur ce que vous avez appris dans le cours INF 1220. [Consultez les notes de cours](https://lemire.github.io/orientee_donnees/).
